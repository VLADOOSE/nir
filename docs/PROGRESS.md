...
**Последнее обновление:** 2026-07-10 (конец сессии). Ветка `main`, HEAD `c24ab69`. Всё ниже — **уже в main**.
...
1. ~~ч.3b авто-парс цены~~ ✔ (2026-07-10, эвристика). Дальше по разбору ответов: **выбор победителя по лоту** (сплит-заказ) + связь с apply/заявкой; сводное КП клиенту; LLM-фолбэк (опт-ин) для сложных/табличных писем; много-лотовый мап цена↔лот.
