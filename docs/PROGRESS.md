...
**Последнее обновление:** 2026-07-11 (конец сессии). Ветка `main`, HEAD `a04d7b2`. Всё ниже — **уже в main**.
