...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 900px) {
      /* Ряд фильтров — flex без переноса, на 390px вылезал за экран на 13px
         (замер финального свипа). Селект после расширения глобального правила
         тач-таргетов стал 40px, и ряд перестал влезать по ширине. */
