...
@Component({
  ...
  styles: [`
    ...
    .header {
      background: var(--header-bg); color: var(--header-text); padding: 0 24px; height: 52px;
    ...
    .header-search input { width: 100%; padding: 8px 16px; border: none; border-radius: 6px; font-size: 14px; background: rgba(255,255,255,0.15); color: var(--header-text); outline: none; box-sizing: border-box; }
    .header-search input::placeholder { color: rgba(255,255,255,0.6); }
    .header-search input:focus { background: rgba(255,255,255,0.25); }
    .search-results { position: absolute; top: 100%; left: 0; right: 0; background: var(--surface); border-radius: 0 0 8px 8px; box-shadow: var(--shadow); max-height: 400px; overflow-y: auto; z-index: 100; }
    .search-result { display: flex; align-items: center; gap: 12px; padding: 10px 16px; cursor: pointer; border-bottom: 1px solid var(--border); }
    ...
    .result-subtitle { font-size: 12px; color: var(--text-muted); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    .sidebar a {
      display: flex; align-items: center; gap: 10px; padding: 9px 20px; color: var(--text); text-decoration: none;
    ...
    .hamburger { display: none; background: transparent; border: none; color: var(--header-text); cursor: pointer; padding: 6px 4px; align-items: center; }
    ...
    @media (max-width: 900px) {
      ...
      .drawer-search { display: block; padding: 4px 12px 10px; border-bottom: 1px solid var(--border); margin-bottom: 6px; }
      .drawer-search input { width: 100%; padding: 9px 12px; border: 1px solid var(--border); border-radius: 8px; font-size: 16px; outline: none; background: var(--surface); color: var(--text); }
