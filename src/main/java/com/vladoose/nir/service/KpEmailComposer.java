...
public class KpEmailComposer {
    ...
    /**
     * ⚠ Обрезка ТЗ держит анти-лик §9 не только эстетически: в ТЗ СК-Фармации ниже требований идёт
     * коммерческий блок (условия/срок поставки, место дислокации, имя и адрес заказчика). На живых
     * 39 ТЗ он начинается не раньше 2528-го символа, то есть за пределами лимита — но при подъёме
     * лимита выше ~2500 заказчик поедет в письмо. Поднимать только вместе с обрезкой этого блока.
     */
