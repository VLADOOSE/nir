...
public interface MedRegistryRepository extends JpaRepository<MedRegistry, Long> {
     ...
     * 55 → 146 из 148 кандидатов). Инвариант — «не больше, чем отобрал identity», а не
     * «выдача не меняется».
     *
     ...
     *   <li>precision_d — доля значимых слов НАЗВАНИЯ ЗАПИСИ, покрытых запросом. Значимое =
     *       ≥4 симв. И в том же алфавите, что запрос (см. комментарий у предиката ниже).
